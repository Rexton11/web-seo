      ...
      {user ? children : (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
          <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-200 max-w-sm w-full text-center">
            <h1 className="text-2xl font-bold text-slate-800 mb-2">B2B CRM</h1>
            <p className="text-slate-500 mb-6 text-sm">Войдите, чтобы получить доступ к воронке продаж, КП и договорам.</p>
            <button
              onClick={signIn}
